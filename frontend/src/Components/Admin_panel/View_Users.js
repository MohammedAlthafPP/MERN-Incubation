                ...
                <tr>
                  ...
                  <td className="d-flex justify-content-center">
                    <Link to={`/user/${item._id}`}>
                      <Button variant="outline-info" className="mt-2 ms-3">
                        <i class="fa-solid fa-eye"></i>
                      </Button>{" "}
                    </Link>
                    <Link to={`/update/${item._id}`}>
                      <Button variant="outline-primary" className="mt-2 ms-3">
                        <i class="fa-solid fa-pen-to-square "></i>
                      </Button>{" "}
                    </Link>

                    {(item.isStatus) ?
                    <Button variant="outline-danger" className="mt-2 ms-3"  onClick={() => onBlockUser(item._id)}>
                      Block
                    </Button>
                    :
                    <Button variant="outline-success" className="mt-2 ms-3"  onClick={() => onUnblockUser(item._id)}>
                      Unblock
                    </Button>
                      }
                    <Button
